  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <h3 class="card-title"><?php echo $websitename->siteadi;?> DNS Kayıtları (<?php echo count($dnslist);?>)</h3>
        </div>
                ...
                <div class="card-footer clearfix">
                  <a href="<?php echo base_url('website/list');?>" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Listeye Dön</a>
                </div>
