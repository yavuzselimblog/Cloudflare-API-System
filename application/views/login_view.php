...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">İşlem yapabilmek için giriş yapınız</p>
      ...
      <form action="" method="post" onsubmit="return false;" id="loginform">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-12">
            <button onclick="loginbuttons();" id="signinbuttons" type="submit" class="btn btn-primary btn-block">Giriş Yapın</button><br>
            <a href="<?php echo base_url('user/register');?>">Kayıt Olun</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
